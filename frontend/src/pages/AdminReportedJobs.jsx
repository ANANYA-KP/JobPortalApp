...
const reports = [
  {
    ...
    reporter: 'user_jdoe88',
    date: 'Oct 24, 2023 • 14:20 PM',
    reason: 'Spam',
    reasonBg: '#FEE2E2', reasonColor: '#991B1B',
    notes: '"This is a repeat post for a position that has already been filled multiple times."',
  },
  {
    id: 2,
    title: 'Remote Data Entry ($50/hr)',
    company: 'Global eHires Ltd',
    posted: 'Posted 5h ago',
    reporter: 'security_analyst',
    date: 'Oct 23, 2023 • 09:12 AM',
    reason: 'Fraudulent',
    reasonBg: '#FFEDD5', reasonColor: '#9A3412',
    notes: '"Asking for credit card details in the application form. Classic phishing pattern."',
  },
  {
    id: 3,
    ...
    reporter: 'pro_seeker_9',
    date: 'Oct 22, 2023 • 11:45 AM',
    reason: 'Inaccurate',
    reasonBg: '#DBEAFE', reasonColor: '#1E40AF',
    notes: '"Job description lists \'junior\' requirements but salary and title are senior-level."',
  },
  {
    id: 4,
    ...
    reporter: 'anonymous_rep',
    date: 'Oct 21, 2023 • 18:30 PM',
    reason: 'Spam',
    reasonBg: '#FEE2E2', reasonColor: '#991B1B',
    notes: '"Redirects to a gambling site when you click \'Apply\'. Dangerous link."',
  },
];
...
const stats = [
  ...
  { label: 'FRAUD POTENTIAL', value: '42', valueColor: '#DC2626', badge: 'High Risk', badgeBg: 'rgba(239,68,68,0.1)', badgeColor: '#EF4444' },
  { label: 'RESOLVED TODAY', value: '156', valueColor: '#16A34A', badge: '✅', badgeBg: null, badgeColor: '#22C55E' },
];

const navItems = [
  { icon: '⊞', label: 'Dashboard' },
  { icon: '💼', label: 'All Jobs' },
  { icon: '🚩', label: 'Reported Jobs', active: true },
  { icon: '👥', label: 'Users' },
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
        ...
        <header style={{ background: '#FFFFFF', borderBottom: '1px solid #E2E8F0', padding: '0 24px', height: 64, display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <button style={{ position: 'relative', background: 'none', border: 'none', cursor: 'pointer', fontSize: 20, padding: 6 }}>
              🔔
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div style={{ width: 36, height: 36, borderRadius: '50%', background: 'rgba(19,127,236,0.2)', border: '1px solid rgba(19,127,236,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, cursor: 'pointer' }}>👤</div>
            </div>
          </div>
        </header>
        ...
        <main style={{ padding: 40, overflowY: 'auto', flex: 1, display: 'flex', flexDirection: 'column', gap: 32 }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8, maxWidth: 600 }}>
              ...
              <p style={{ fontSize: 16, color: '#64748B', lineHeight: '24px' }}>
                Manage and review job postings flagged by the community. Investigate potential fraud, spam, or inaccuracies to maintain platform quality.
              </p>
            </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            {filterTabs.map(tab => (
              <button
                key={tab}
                className={`filter-pill ${activeFilter === tab ? 'active' : 'inactive'}`}
          ...
          <div style={{ background: '#FFFFFF', border: '1px solid #E2E8F0', borderRadius: 12, overflow: 'hidden' }}>
            ...
            <div>
              {filtered.map(report => (
                <div key={report.id} className="table-row">
                  ...
                  {/* Notes */}
                  <div style={{ fontSize: 14, color: '#475569', lineHeight: '20px', overflow: 'hidden', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical' }}>
                    {report.notes}
                  </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px 24px', borderTop: '1px solid #E2E8F0' }}>
              <p style={{ fontSize: 14, color: '#64748B' }}>
                Showing <strong style={{ color: '#0F172A' }}>1 to 10</strong> of <strong style={{ color: '#0F172A' }}>1,284</strong> reports
              </p>
          ...
          <div style={{ display: 'flex', gap: 24 }}>
            ...
            <div style={{ flex: 1, background: 'rgba(19,127,236,0.05)', border: '1px solid rgba(19,127,236,0.2)', borderRadius: 12, padding: 24, display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              <p style={{ fontSize: 14, color: '#475569', lineHeight: '23px' }}>
                When reviewing <strong>Fraudulent</strong> reports, always check the company's registration details and past job posting history. If multiple users report the same listing for phishing, consider an immediate temporary suspension of the employer account.
              </p>
            </div>
        ...
        <footer style={{ borderTop: '1px solid #E2E8F0', padding: '20px 40px', textAlign: 'center' }}>
          <p style={{ fontSize: 12, color: '#94A3B8' }}>© 2023 oobPortal Admin Panel • v2.4.0 • All Rights Reserved</p>
        </footer>
      </div>
    </div>
  );
